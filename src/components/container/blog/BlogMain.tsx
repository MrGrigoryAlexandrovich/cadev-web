...
const BlogMain = () => {
  ...
  return (
    <section className="blog-main fade-wrapper st-wrap-t">
      <div className="container">
        <div className="row gaper">
          <div className="col-12 col-xl-8 der">
            <div className="blog-main__content st-con">
              <div className="blog-main__single fade-top">
                ...
                <div className="content ">
                  ...
                  <p>
                    Daily Star News published on Feb 2nd, 2022, Sangbad Protidin
                    dated January 31st, 2022 and HRCBM&apos;s investigation.
                    Bangladesh again witnessing uptick in violence against
          ...
          <div className="col-12 col-xl-4 fer">
            <div className="blog-main__sidebar st-con">
              <div className="widget  fade-top">
