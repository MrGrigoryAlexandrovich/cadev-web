...
const BlogDetailsSec = () => {
  return (
    <section className="blog-main blog-details fade-wrapper st-wrap-t">
          ...
          <div className="col-12 col-xl-8 ">
            <div className="st-con">
                ...
                <div className="bd-content">
                  <div className="bd-meta">
                    <div className="meta__left">
                      <p>
                        <strong>Written by : </strong> Marry biden
                      </p>
                      <span></span>
                      <p>10/01/2023</p>
                    </div>
              ...
              <div className="blog-details__pagination">
                ...
                <div className="pt-120 pb-0 comment-form fade-top">
                  <div className="section__header">
                    <h2 className="text-start">Leave a comment</h2>
                  </div>
